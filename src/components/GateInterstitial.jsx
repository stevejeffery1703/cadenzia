...
// — not a wall. The honest ask (subscribe, at the moment focus has clearly been
// valuable) sits first; an equally real "continue free today" is the soft escape.
// Sharing lives elsewhere, on positive surfaces — asking for it here, at a toll,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-paper px-6 page-enter">
      <div className="w-full max-w-2xl text-center">
        ...
        <div className="mt-10 grid gap-4 text-left sm:grid-cols-2">
          {/* Subscribe — the honest ask, first, at the moment of demonstrated value. */}
          ...
          {/* Continue free — the soft, honest escape. No share dressed up as a toll. */}
          <div className="panel flex flex-col p-6">
