    ...
    >
      ...
      >
        ...
        <p className="mx-auto mt-4 text-sm leading-relaxed text-ink-soft">
          Every piece is played and recorded by hand — never generated by AI — and a new one is added
        ...
        <div className="mt-8 border-t border-line pt-6">
          <p className="text-caption mx-auto max-w-xs">
            No ads here. Cadenzia reaches the next person only when someone passes it on.
          </p>
          {canNativeShare ? (
            <button
              type="button"
